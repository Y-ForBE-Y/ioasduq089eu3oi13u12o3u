...
local module_2_upvr = {
    ...
    Moonstone = {
        ...
        From = "Ancient Isle";
        FromMeteor = true;
        Evaluation = "Moonstone's hard, ethereal glowвЂ”caused by light scattering within its layersвЂ”, often associated with the lunar energy from our lovely moon.";
    };
    ["Lapis Lazuli"] = {
        WeightPool = {4, 14};
        Chance = 0;
    ...
    ["Corsair Grouper"] = {
        ...
        Rarity = "Common";
        Resilience = 100;
        Description = "The Corsair Grouper is a resilient, bulky fish, often hiding among shores. Known for its powerful bites, itвЂ™s a decent challenge for beginners.";
    ...
    ["Cursed Eel"] = {
        ...
        Resilience = 15;
        ProgressEfficiency = 0.5;
        Description = "Cursed Eels linger in darker waters, giving off an eerie glow. TheyвЂ™re a spooky find for night anglers.";
    ...
    ["Golden Seahorse"] = {
        ...
        Rarity = "Mythical";
        Resilience = 10;
        Description = "Golden Sea Horses are small but enchanting, drifting near seaweed & algae. Gentle and rare, theyвЂ™re a delight to find.";
    ...
    Leedsichthys = {
        ...
        Resilience = 30;
        ProgressEfficiency = 0.75;
        Description = "Leedsichthys is a colossal, plankton-feeding fish from the Jurassic period, approximately 165вЂ“150 million years ago. It is one of the largest fish ever to exist, showcasing the diversity of prehistoric marine life.";
    ...
    Anchovy = {
        ...
        Hint = "Caught in all saltwaterвЂ™s of Moosewood";
        FavouriteBait = "None";
        FavouriteTime = "Day";
        Price = 30;
        XP = 20;
    ...
    ["Volcanic Geode"] = {
        ...
        Rarity = "Rare";
        Resilience = 120;
        Description = "The Volcanic Geode encases a magma crystal core, preserving its contents with an amber-like quality. Within this geode, you might find a trove of rare or extinct treasuresвЂ” it's like a volcanic Christmas!";
    ...
    Bluegill = {
        ...
        Hint = "Found in saltwaterвЂ™s near Snowcap.";
        FavouriteBait = "Insect";
        FavouriteTime = nil;
        Price = 60;
        XP = 90;
    ...
    Wiifish = {
        ...
        Resilience = 40;
        ProgressEfficiency = 0.8;
        Description = "The Wiifish is a legendary tropic fish that can only be found in the saltwaterвЂ™s Sunstone Island during the day. They are an extremely old fish, dating back over 230,000,000 years ago. While the Wiifish is a slow swimmer, they can put up an immense fight for even advanced anglers.";
    ...
    Ghoulfish = {
        ...
        Seasons = {"None"};
        Weather = {"Clear"};
        Quips = {"A Ghoulfish!", "I caught a Ghoulfish!", "Woah! A Ghoulfish!", "Ouu! A Ghoulfish!", "what? there's nothing there..", "рџ‘»рџ‘»рџ‘»"};
        SparkleColor = Color3.fromRGB(255, 255, 255);
        HoldAnimation = fish:WaitForChild("basic");
