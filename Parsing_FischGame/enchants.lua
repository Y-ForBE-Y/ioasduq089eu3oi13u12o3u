local module = {
    Enchants = {
        ...
        Breezed = {
            ...
            ConditionalBoosts = "function: 0xef594f14eac37d56";
        ...
        Flashline = {
            Color = "1, 1, 1";
            ConditionalBoosts = "function: 0x69ea212f1536b776";
        ...
        Momentum = {
            ...
            ConditionalBoosts = "function: 0xab73094a075c0d96";
        ...
        Tenacity = {
            ...
            ConditionalBoosts = "function: 0x6474a3a0e1a919d6";
    ...
    -- Системные поля
    LoadVisual = "function: 0xdc4007dca59d2856";
}
