...
local longstring2 = "Lobsters are valuable crustaceans known for their rich, succulent meat. Lobsters are most active in the summer to autumn, and are commonly caught in crab cages during calm clear days."
...
function module_upvr.ToInteger(arg1, arg2) -- Line 24130
    return math.floor(arg2.r * 255) * 65536 + math.floor(arg2.g * 255) * 256 + math.floor(arg2.b * 255)
end
function module_upvr.ToHex(arg1, arg2) -- Line 24134
    --[[ Upvalues[1]:
    ...
    local var5250
    repeat
        local var5251 = any_ToInteger_result1 % 16
        local tostring_result1 = tostring(var5251)
        if 10 <= var5251 then
            tostring_result1 = ({'A', 'B', 'C', 'D', 'E', 'F'})[1 + var5251 - 10]
        end
        var5250 = var5250..tostring_result1
